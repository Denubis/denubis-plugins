...
imported: 2026-06-11
adaptation: light-touch — denubis voice tweaks and one cross-reference annotation; scenario content obra-authored. 2026-07-05 — merged the available_skills XML correction from the earlier (2026-04-20) testing-skills-with-subagents copy during duplicate consolidation; that copy is deleted
---
