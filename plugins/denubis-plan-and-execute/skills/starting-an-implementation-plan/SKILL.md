...
1. **REQUIRED SUB-SKILL:** Use denubis-plan-and-execute:using-git-worktrees
...
cat /path/to/plugins/denubis-plan-and-execute/skills/starting-an-implementation-plan/SKILL.md
```
