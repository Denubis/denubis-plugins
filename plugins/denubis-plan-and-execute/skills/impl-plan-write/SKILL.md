...
- For verifying API surfaces, class hierarchies, or usage patterns, instruct the investigator to use ast-grep for structural searches (see `using-code-search` skill)
