...
<!-- START_TASK_1 -->
### Task 1: Create Proleptic Challenge Skill

**Files:**
- Create: `plugins/denubis-plan-and-execute/skills/proleptic-challenge/SKILL.md`
...
head -5 plugins/denubis-plan-and-execute/skills/proleptic-challenge/SKILL.md
```

Expected: YAML frontmatter with name: proleptic-challenge, description

**Step 3: Commit the skill**

```bash
git add plugins/denubis-plan-and-execute/skills/proleptic-challenge/SKILL.md
git commit -m "feat(plan-and-execute): add proleptic-challenge skill

Documents when and how to invoke proleptic-challenger agent:
- Before design finalisation
- Between implementation phases
- During UAT

Includes invocation templates and presentation format.
